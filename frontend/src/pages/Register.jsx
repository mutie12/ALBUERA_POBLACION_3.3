      ...
      <div className="auth-container">
        ...
        <div className="auth-image-panel">
          <div className="auth-image-content">
            <span className="emergency-icon"><Icon name="checkCircle" size={48} color="#10b981" /></span>
        ...
        <div className="auth-form-panel">
          <div className="auth-card" style={{ textAlign: "center" }}>
            <div className="logo">
              <span className="logo-icon"><Icon name="checkCircle" size={28} color="#10b981" /></span>
            </div>
              ...
              <div style={{ 
                ...
                margin: "16px 0"
                  ...
                  <p style={{ fontSize: "0.875rem", color: "#065f46" }}>
                    <Icon name="checkCircle" size={16} style={{ marginRight: "4px", color: "#10b981" }} />A verification email has been sent to your email address
                  </p>
              </div>
            )}
            ...
            <div style={{ 
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "12px" }}>
                ...
                >
                  {copied ? <span style={{ color: "var(--accent-emerald)" }}><Icon name="checkCircle" size={20} /></span> : <span style={{ color: "var(--gray-400)" }}><Icon name="fileText" size={20} /></span>}
                </button>
              </div>
            </div>
        ...
        <div className="auth-card" style={{ background: "#f0fdf4", border: "2px solid #22c55e" }}>
          ...
          {error && (
            <div className="error-message" style={{ marginBottom: "20px" }}>
              <span className="icon"><Icon name="alertTriangle" size={18} /></span>
              <span>{error}</span>
            </div>
          )}
          ...
          <div style={{ marginTop: "32px", paddingTop: "24px", borderTop: "1px solid var(--gray-200)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px", fontSize: "0.8125rem", color: "var(--text-secondary)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  <span style={{ color: "var(--accent-emerald)" }}><Icon name="checkCircle" size={18} color="var(--accent-emerald)" /></span>
