...
function ResidentMessages() {
  ...
  const getEmergencyIcon = (type, size = 20) => {
    if (type === "resident-emergency") return <Icon name="siren" size={size} color="#ef4444" />;
        ...
        <div style={{ 
          ...
          {selectedMessage ? (
            ...
            <div style={{ 
              ...
              <Icon name="inbox" size={48} style={{ marginBottom: "12px", color: "#9ca3af" }} />
