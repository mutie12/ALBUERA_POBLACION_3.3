...
import { Icon, getEmergencyIconAsComponent } from "../components/Icon";
    ...
    <div className="resident-layout" style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <aside className="sidebar">
        <div className="sidebar-header">
          <div className="logo">
            <span className="logo-icon"><Icon name="siren" size={24} color="#f97316" /></span>
          </div>
        ...
        <nav className="sidebar-nav">
          <div className="nav-section">
            ...
            <Link to="/resident" className="nav-item">
              <span className="icon"><Icon name="fileText" size={16} /></span>
              Emergency List
            </Link>
            <div className="nav-item active">
              <span className="icon"><Icon name="bell" size={16} /></span>
              Report Emergency
            </div>
          </div>
        ...
        <div className="sidebar-footer">
          <Link to="/login" className="nav-item" style={{ color: "var(--accent-red)" }}>
            <span className="icon"><Icon name="doorOpen" size={16} /></span>
            Logout
          </Link>
        </div>
      </aside>
      ...
      <main className="main-content">
        ...
        <div className="main-header">
          <h1><Icon name="siren" size={22} /> Report Emergency</h1>
        </div>
          ...
          <div className="report-form-card">
            ...
            {error && (
              <div className="error-message" style={{ marginBottom: "24px" }}>
                <Icon name="alertTriangle" size={16} style={{ marginRight: "6px" }} />
                <span>{error}</span>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Location */}
              <div className="form-group">
                <label><Icon name="mapPinned" size={14} style={{ marginRight: "4px" }} />Location <span className="required">*</span></label>
                <select
                  value={location}
              ...
              <div className="form-group">
                ...
                <div className="emergency-types-grid">
                  {emergencyTypes.map((type) => (
                    ...
                    >
                      <span className="icon" style={{ color: getEmergencyColor(type) }}>
                        {getEmergencyIconAsComponent(type, 20)}
                      </span>
            ...
            <div style={{ marginTop: "32px", padding: "16px", background: "#fef3c7", borderRadius: "10px", border: "1px solid #fde68a" }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
                <Icon name="alertTriangle" size={20} color="#92400e" />
                <div>
