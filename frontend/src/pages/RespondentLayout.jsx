        ...
        <div className="sidebar-header">
          ...
          <div className="user-info">
            ...
            <div>
              ...
              <div className="user-role"><Icon name="ambulance" size={16} style={{ marginRight: "4px" }} /> Respondent</div>
            </div>
          </div>
        </div>
        ...
        <nav className="sidebar-nav">
          <div className="nav-section">
            ...
            <Link 
              ...
              state={{ view: "queue" }}
            >
<span className="icon"><Icon name="siren" size={16} /></span>
               Emergency Tasks
...
<span className="icon"><Icon name="fileText" size={16} /></span>
      ...
      <main className="main-content" style={{ paddingLeft: "64px", paddingRight: "24px" }}>
        <div className="main-header">
          <h1><Icon name="ambulance" size={22} style={{ marginRight: "6px" }} /> Respondent Dashboard</h1>
