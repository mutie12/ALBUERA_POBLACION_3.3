    ...
    <div className="resident-layout" style={{ display: "flex", minHeight: "100vh" }}>
      <aside className="sidebar" style={{ background: '#ffffff', boxShadow: '2px 0 10px rgba(0,0,0,0.1)', width: '300px', minWidth: '300px' }}>
        ...
        <nav className="sidebar-nav" style={{ padding: '16px 12px' }}>
          <div className="nav-section" style={{ marginBottom: '24px' }}>
            ...
            >
              <Icons.LuBarChart2 size={18} color="var(--primary-600)" />
              Dashboard
            </Link>
            <Link 
              to="/my-reports" 
            ...
            <Link 
              ...
              style={{
                ...
                padding: "12px 16px",
                borderRadius: "8px",
                background: location.pathname === "/resident/message" ? "var(--primary-50)" : "transparent",
                color: location.pathname === "/resident/message" ? "var(--primary-600)" : "var(--text-secondary)",
                fontWeight: location.pathname === "/resident/message" ? 600 : 500,
                textDecoration: "none",
                transition: "all 0.2s"
              }}>
          ...
          <div className="nav-section" style={{ marginBottom: '24px' }}>
            ...
            <div style={{ padding: "8px 16px", display: "flex", flexDirection: "column", gap: "6px" }}>
              {[
                { iconName: "phone", name: "Emergency (Nationwide)", number: "911", color: "#dc2626" },
                { iconName: "shield", name: "Police", number: "0905-525-4417", color: "#3b82f6" },
                { iconName: "flame", name: "Bureau of Fire", number: "160 / 0910 731 7191", color: "#f97316" },
                { iconName: "crosshair", name: "Red Cross", number: "143", color: "#ef4444" },
                { iconName: "radio", name: "Albuera MDRRMO", number: "(053) 323-2692", color: "#10b981" },
                { iconName: "landmark", name: "Municipal Hall", number: "(053) 323-2693", color: "#6366f1" },
                { iconName: "stethoscope", name: "Albuera RHU", number: "(053) 323-2694", color: "#14b8a6" },
              ].map((hotline) => (
                <a
                  key={hotline.name}
                ...
                >
                  {hotline.iconName && <Icon name={hotline.iconName} size={16} color={hotline.color} />}
                  ...
                  <Icon name="phone" size={14} style={{ color: "#9ca3af" }} />
                </a>
              ))}
            </div>
          </div>
      ...
      <main className="main-content">
        <div className="main-header" style={{ padding: '20px 24px', borderBottom: '1px solid #e5e7eb', background: 'white', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: '700', color: '#1f2937' }}>{location.pathname === "/profile" ? <><Icon name="user" size={22} /> My Profile</> : <><Icon name="home" size={22} /> Resident Dashboard</>}</h1>
          <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
            <button onClick={fetchReports} className="btn btn-secondary" title="Refresh">
              <Icons.LuRefreshCw size={18} />
            </button>
                        ...
                        {notif.type === "emergency" ? (
                         <div>
                           <div style={{ fontSize: "0.875rem", fontWeight: "600", marginBottom: "4px", color: "#dc2626" }}>
                             <><Icon name="siren" size={14} style={{ marginRight: "4px" }} />{notif.title}</>
                           </div>
