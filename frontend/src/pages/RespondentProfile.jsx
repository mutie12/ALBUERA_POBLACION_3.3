    ...
    <div className="admin-page-container">
      <div style={{ maxWidth: "100%", margin: "0 auto" }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            ...
            <div>
              ...
              <p style={{ margin: "4px 0 0", opacity: 0.9 }}><Icon name="ambulance" size={14} style={{ marginRight: "4px" }} />Emergency Respondent</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <><Icon name="user" size={22} style={{ marginRight: "6px" }} /> Personal Information</>
          </h3>
        ...
        <div style={{ 
          ...
          <h3 style={{ marginBottom: "20px", color: "#1f2937", display: "flex", alignItems: "center", gap: "8px" }}>
          <><Icon name="key" size={22} style={{ marginRight: "6px" }} /> Change Password</>
          </h3>
